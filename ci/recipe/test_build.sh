...
conda install -p "./testing-${Q2V}" -q -y -c "$CONDA_ENVS/qiime2-${Q2V}-buildtest/conda-bld/${OSV}-64" -c conda-forge -c bioconda -c defaults --override-channels --strict-channel-priority q2-moshpit
